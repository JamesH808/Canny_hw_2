...
/* CENG 381 Assignment 2 solution*/

/* bugged fixed on line 717 and 721 by Rainer Doemer, for assignment 2 */
        ...
        short int smoothedim)
{
   ...
   float kernel[ROWS*COLS];        /* A one dimensional gaussian kernel. */
